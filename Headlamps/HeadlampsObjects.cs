...
namespace r1ft.Headlamps
{
    internal static class HeadLamps
    {
        ...
        public static string[] Lights = new[] {
            "/item_equipment_helmet_opsCore_single_clamp_rail_adapter(Clone)/mod_flashlight/flashlight_ultrafire_WF-501B(Clone)/mode_001",
            "/item_equipment_helmet_opsCore_single_clamp_rail_adapter(Clone)/mod_flashlight/flashlight_armytek_predator_pro_v3_xhp35_hi(Clone)/mode_001",
            "/item_equipment_helmet_opsCore_picatinny_rail_adapter(Clone)/mod_mount/tactical_all_surefire_x400_vis_laser(Clone)/mode_002",
            "/item_equipment_helmet_opsCore_picatinny_rail_adapter(Clone)/mod_mount/tactical_all_zenit_2p_kleh_vis_laser(Clone)/mode_001"
        };

        public static string[] AltMode = new[] {
            "/item_equipment_helmet_opsCore_picatinny_rail_adapter(Clone)/mod_mount/tactical_all_surefire_x400_vis_laser(Clone)/mode_003",
            "/item_equipment_helmet_opsCore_picatinny_rail_adapter(Clone)/mod_mount/tactical_all_zenit_2p_kleh_vis_laser(Clone)/mode_003"
        };
    }
}
